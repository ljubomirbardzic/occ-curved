import * as THREE from "three";
  ...
  `,
                    ...
                    const planeWidth = 1.5; // This must match your PlaneGeometry width
                    const planeHeight = 1;
                    ...
                    if (loadedTextures === totalTextures) {
                      // Render only after all images are loaded
            ...
            function onResize() {
              ...
              if (newWidth === previousWidth) return; // skip redundant resizes
